...
{
    /// <inheritdoc />
    public partial class AddAspNetCoreIdentityAndGoogleLogin : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                ...
                SET
                    ...
                    EmailConfirmed = 1
                WHERE NormalizedEmail IS NULL OR NormalizedUserName IS NULL OR SecurityStamp IS NULL OR ConcurrencyStamp IS NULL
                """);
